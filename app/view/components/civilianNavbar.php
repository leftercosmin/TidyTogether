...
<nav class="navbar">
  <div class="navbar-container">
    ...
    <div class="navbar-links">
      ...
      <a href="?civilianPage=civilianReportPage" class="nav-link <?php echo ($currentPage === 'civilianReportPage') ? 'active' : ''; ?>">
      ...
      <a href="?civilianPage=profilePage" class="nav-link <?php echo ($currentPage === 'profilePage') ? 'active' : ''; ?>">
      ...
      <a href="?civilianPage=zoneReportPage" class="nav-link <?php echo ($currentPage === 'zoneReportPage') ? 'active' : ''; ?>">
